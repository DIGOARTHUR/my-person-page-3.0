        ...
        <div id='stacks' className=" flex flex-col w-full ">
            ...
            <div className="grid  grid-cols-5 max-w-2xl items-center gap-5  max-sm:grid-cols-3 ">
                ...
                <div className="flex justify-center ">
                    <img className=" h-16" src="https://user-images.githubusercontent.com/59892368/232161128-97f075cf-3a5b-4357-a552-21958e5510f6.svg" />
                </div>
                <div className="flex justify-center ">
                ...
                <div className="flex justify-center ">
                    <img className="h-16" src="https://user-images.githubusercontent.com/59892368/232161131-9f3917c0-ac40-466b-a217-dde64beae7f4.svg" />
                </div>
                <div className="flex justify-center ">
